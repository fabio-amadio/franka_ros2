...
class EndEffectorMarkerNode(Node):
    def __init__(self):
        ...
        self.grasp_cli = ActionClient(self, Grasp, '/franka_gripper/grasp', callback_group=self.callback_group)
        ...
        self.gripper_cli = ActionClient(self, GripperCommand, '/franka_gripper/gripper_action', callback_group=self.callback_group)
